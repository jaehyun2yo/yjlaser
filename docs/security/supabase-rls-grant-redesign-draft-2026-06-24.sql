-- DRAFT ONLY. DO NOT APPLY WITHOUT EXPLICIT USER APPROVAL.
--
-- Purpose:
...
-- - Re-run metadata-only read-only check.
-- - Confirm desktop service_role RPC smoke paths.
-- - Convert this draft into the approved migration path.
