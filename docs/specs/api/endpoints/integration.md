...
| yjlaser_website (관리자)    | `POST /integration/api-keys`, `GET /integration/api-keys`, `DELETE /integration/api-keys/:id`, `GET /integration/sync-logs/pipeline-backlog`, `GET /integration/operations/failures`                                                                                                                                                                                                                                     |
